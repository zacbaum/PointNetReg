...
def predict_mr_us_file(name, path):
...
def predict_mr_us_file_Sweep(name, path):
	#if not os.path.exists('./prostate_results-' + name + '/'):
	#		os.mkdir('./prostate_results-' + name + '/')
	...
	for i in range(max_iters):
		...
		swept_prostate = np.reshape(swept_prostate, (-1, 3))
		x_fp, y_fp, z_fp = get_unique_plot_points(swept_prostate)
		ax.scatter(x_fp, y_fp, z_fp, c='y', marker='.', alpha=0.2)
		set_plot_ax_lims([ax], limit=1)
		plt.show()
		plt.savefig('plane.png', dpi=300)
		plt.close()
...
if __name__ == "__main__":
	...
	# 70-30
	'''
	predict_mr_us_file("f2f_70-30_baseline-cd_no-aug",   "./models/full-to-full/70-30/baseline-cd/no-aug/model-best")
	predict_mr_us_file("f2f_70-30_baseline-cd_disp",     "./models/full-to-full/70-30/baseline-cd/disp/model-best")
	predict_mr_us_file("f2f_70-30_baseline-cd_disp-rot", "./models/full-to-full/70-30/baseline-cd/disp-rot/model-best")

	predict_mr_us_file("f2f_70-30_baseline-gmm_no-aug",   "./models/full-to-full/70-30/baseline-gmm/no-aug/model-best")
	predict_mr_us_file("f2f_70-30_baseline-gmm_disp",     "./models/full-to-full/70-30/baseline-gmm/disp/model-best")
	predict_mr_us_file("f2f_70-30_baseline-gmm_disp-rot", "./models/full-to-full/70-30/baseline-gmm/disp-rot/model-best")

	predict_mr_us_file("f2f_70-30_fpt-cd_no-aug",   "./models/full-to-full/70-30/fpt-cd/no-aug/model-best")
	predict_mr_us_file("f2f_70-30_fpt-cd_disp",     "./models/full-to-full/70-30/fpt-cd/disp/model-best")
	predict_mr_us_file("f2f_70-30_fpt-cd_disp-rot", "./models/full-to-full/70-30/fpt-cd/disp-rot/model-best")

	predict_mr_us_file("f2f_70-30_fpt-gmm_no-aug",   "./models/full-to-full/70-30/fpt-gmm/no-aug/model-best")
	predict_mr_us_file("f2f_70-30_fpt-gmm_disp",     "./models/full-to-full/70-30/fpt-gmm/disp/model-best")
	predict_mr_us_file("f2f_70-30_fpt-gmm_disp-rot", "./models/full-to-full/70-30/fpt-gmm/disp-rot/model-best")
	'''
