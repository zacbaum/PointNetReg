...
class Prediction_Plotter(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):    
        ...
        for batch_id in range(0, pred.shape[0], 25):
            ...
            if self.debug:
                ...
                plt.show()
                plt.savefig('./results/' + str(self.fname_tag) + '_id_' + str(batch_id + 1) + '_epoch_' + str(epoch + 1) + '_reg-scatter-PRED_ONLY.png', dpi=250)
                plt.close()
